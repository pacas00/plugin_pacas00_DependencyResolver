...
namespace YOUR_NAMESPACE_HERE // I wont help you if you use the global namespace.
{

    public class DependencyResolver_basic
    {
        ...
        /// <summary>
        /// Adds the assembly from file. Used for loading in the lib cache
        /// </summary>
